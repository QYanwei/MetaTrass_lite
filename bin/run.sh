...
python="/zfsqd1/ST_OCEAN/USRS/qiyanwei/software/api/MetaTrass/bin/python3"
Trass="/zfsqd1/ST_OCEAN/USRS/qiyanwei/software/api/MetaTrass/Trass.py"
ref_db="/zfsqd1/ST_OCEAN/USRS/qiyanwei/software/api/MetaTrass/database/uhgg_kraken2-db/"
ref_fa="/zfsqd1/ST_OCEAN/USRS/qiyanwei/software/api/MetaTrass/database/uhgg_kraken2-fa/"
ref_gz="/zfsqd1/ST_OCEAN/USRS/qiyanwei/software/api/MetaTrass/config/all_single_species_genome_size.uhgg.txt"
