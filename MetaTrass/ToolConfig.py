...
config_dict = {
               ...
               'spades'          : '%s/spades.py' % config_tool_path,
               'quast'                : '%s/quast/quast.py'        % config_tool_path,

               # modules
               'stlfr2supernova'      : '%s/stlfr2supernova/stlfr2supernova.py'       % config_tool_path,
               'stlfr2cloudspades'    : '%s/stlfr2cloudspades/stlfr2cloudspades.py'   % config_tool_path,
